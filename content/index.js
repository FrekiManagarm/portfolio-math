export const content = {
    nav: {
      ...
      links: [
        ...
        { text: 'Mes Outils', to: 'mystack'},
        { text: 'Mes expériences', to: 'experience' },
        { text: 'Contact', to: 'mycontact' },
      ],
    },
    header: {
      img:
        'https://i.imgur.com/mu73rN0.jpg',
      imgPlaceholder:
      ...
      text: ['Bonjour !', "Moi c'est Mathieu."],
      typical: [
    ...
    stack: {
      ...
      tech: [
        {
          img: 'https://i.imgur.com/QSZW8g0.png',
          alt: 'laravel',
        },
        {
          img: 'https://i.imgur.com/XIQM827.png',
          alt: 'nextjs',
        },
        {
        ...
        {
          img: 'https://i.imgur.com/gDXgOm6.png',
          alt: 'reactnative'
        },
        {
          img: 'https://i.imgur.com/IGhwxNk.png',
          alt: 'mysql'
        }
      ],
